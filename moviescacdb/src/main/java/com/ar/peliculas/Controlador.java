...
public class Controlador extends HttpServlet { // Declaración de la clase Controlador que extiende HttpServlet
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            Pelicula pelicula = mapper.readValue(request.getInputStream(), Pelicula.class);  // Convertir el JSON de la solicitud a un objeto 
        
            // Consulta SQL para insertar un registro
            String query = "INSERT INTO peliculas (nombre, descrip, portada) VALUES (?, ?, ?)";
            ...
            statement.setString(2, pelicula.getDescrip());
            statement.setString(3, pelicula.getPortada());
            ...
            if (rs.next()) 
            {
                Long idpel = rs.getLong(1);  // Obtener el valor del primer campo generado automáticamente (en este caso, el ID)
                ...
                String json = mapper.writeValueAsString(idpel);  // Convertir el ID a formato JSON
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            String query = "delete from peliculas  where idpel =?";
