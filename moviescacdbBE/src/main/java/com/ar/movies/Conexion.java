...
public class Conexion 
{
    ...
    public Conexion() 
    {
        try 
        {
            ...
            // Paso 2: Establecer la conexión con la base de datos 'moviescac_java' en localhost
            this.connection = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/moviescac_java",  // URL de conexión JDBC para MySQL
                "root",  // Nombre de usuario de la base de datos (cambia según tu configuración)
                "asd123"  // Contraseña de la base de datos (cambia según tu configuración)
            );
        } 
